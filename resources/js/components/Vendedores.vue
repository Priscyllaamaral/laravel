         ...
         <div class="modal fade" id="confirmar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Deseja mesmo deletar este Vendedor?</h5>
...
const urlParams = new URLSearchParams(queryString);
    ...
    export default {
        ...
        methods:{
            ...
            deletar: function (id) {
                try{
                    axios.post(Config.baseURL + `/vendedores/destroy/${id}`)
                    .then(response => {
            ...
            async carregar(){
                try{
                    let resultado = await axios.get(Config.baseURL + '/vendedores/listar/');
            ...
            editar(id){
                window.location.href = Config.baseURL + '/vendedores/editar?id='+id;
            },
